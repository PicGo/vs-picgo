...
function addRenameListener(picgo: PicGoType, editor: vscode.TextEditor) {
  picgo.on('beforeUpload', (ctx: IPicGoCtx) => {
...
function addGenerateOutputListener(picgo: PicGoType, editor: vscode.TextEditor) {
...
function getPicgo(editor: vscode.TextEditor): PicGoType {
