...
export class CoverageCollector {
  ...
  constructor(basePath: string, private options: ICoverageCollectorOptions) {
  ...
  public setup(): void {
    ...
    (istanbul.hook as any).hookRequire(this.matchFn, this.transformer, hookOpts);
  ...
  public report(): void {
    ...
    const coverageFile = path.resolve(this.options.output, 'coverage' + pidExt + '.json');
